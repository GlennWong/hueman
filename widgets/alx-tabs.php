...
/* ------------------------------------ */
	function AlxTabs() {
		parent::__construct( false, '选项卡', array('description' => 'List posts, comments, and/or tags with or without tabs.', 'classname' => 'widget_alx_tabs') );;	
	}
...
/* ------------------------------------ */
	private function _create_tabs($tabs,$count) {
		...
		$titles = array(
			'recent'	=> __('最近文章','hueman'),
			'popular'	=> __('最热文章','hueman'),
			'comments'	=> __('最新评论','hueman'),
			'tags'		=> __('标签','hueman')
		);
		$icons = array(
			...
			<ul id="tab-recent" class="alx-tab group <?php if($instance['recent_thumbs']) { echo 'thumbs-enabled'; } ?>">
				...
				<li>
					...
					<div class="tab-item-inner group">
						<?php if($instance['tabs_category']) { ?><p class="tab-item-category left"><i class="fa fa-folder-open"></i> <?php the_category(' / '); ?></p><?php } ?>
						<?php if($instance['tabs_date']) { ?><p class="tab-item-date right"><?php the_time('Y年m月j日'); ?></p><?php } ?>
						<p class="tab-item-title left"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>"><?php the_title(); ?></a></p>
					</div>
		...
		<?php if($instance['popular_enable']) { // Popular posts enabled? ?>
			...
			<ul id="tab-popular" class="alx-tab group <?php if($instance['popular_thumbs']) { echo 'thumbs-enabled'; } ?>">
				...
				<li>
					...
					<div class="tab-item-inner group">
						<?php if($instance['tabs_category']) { ?><p class="tab-item-category left"><?php the_category(' / '); ?></p><?php } ?>
						<?php if($instance['tabs_date']) { ?><p class="tab-item-date right"><?php the_time('Y年m月j日'); ?></p><?php } ?>
						<p class="tab-item-title left"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>"><?php the_title(); ?></a></p>
					</div>
			...
			<ul id="tab-comments" class="alx-tab group <?php if($instance['comments_avatars']) { echo 'avatars-enabled'; } ?>">
				...
				<li>
						...
						<div class="tab-item-inner group">
							...
							<div class="tab-item-name"><?php echo $comment->comment_author; ?>：</div>
...
?>
	...
	<div class="alx-options-tabs">
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('recent_enable'); ?>">启用最新文章</label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('recent_thumbs'); ?>">显示缩略图</label>
		</p>	
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("recent_num"); ?>">显示条目数</label>
		...
		<p>
			<label style="width: 100%; display: inline-block;" for="<?php echo $this->get_field_id("recent_cat_id"); ?>">分类:</label>
			<?php wp_dropdown_categories( array( 'name' => $this->get_field_name("recent_cat_id"), 'selected' => $instance["recent_cat_id"], 'show_option_all' => '所有', 'show_count' => true ) ); ?>		
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('popular_enable'); ?>">启用热门文章</label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('popular_thumbs'); ?>">显示缩略图</label>
		</p>	
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("popular_num"); ?>">显示条目数</label>
		...
		<p>
			<label style="width: 100%; display: inline-block;" for="<?php echo $this->get_field_id("popular_cat_id"); ?>">分类:</label>
			<?php wp_dropdown_categories( array( 'name' => $this->get_field_name("popular_cat_id"), 'selected' => $instance["popular_cat_id"], 'show_option_all' => '所有', 'show_count' => true ) ); ?>		
		</p>
		<p style="padding-top: 0.3em;">
			<label style="width: 100%; display: inline-block;" for="<?php echo $this->get_field_id("popular_time"); ?>">选择显示某时间段热门文章:</label>
			<select style="width: 100%;" id="<?php echo $this->get_field_id("popular_time"); ?>" name="<?php echo $this->get_field_name("popular_time"); ?>">
			  <option value="0"<?php selected( $instance["popular_time"], "0" ); ?>>所有时间</option>
			  <option value="1 year ago"<?php selected( $instance["popular_time"], "1 year ago" ); ?>>这一年内</option>
			  <option value="1 month ago"<?php selected( $instance["popular_time"], "1 month ago" ); ?>>这一月内</option>
			  <option value="1 week ago"<?php selected( $instance["popular_time"], "1 week ago" ); ?>>这一周内</option>
			  <option value="1 day ago"<?php selected( $instance["popular_time"], "1 day ago" ); ?>>这一天内</option>
			</select>	
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('comments_enable'); ?>">启用最近评论</label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('comments_avatars'); ?>">显示头像</label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("comments_num"); ?>">显示条目数</label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('tags_enable'); ?>">显示标签</label>
		</p>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("order_recent"); ?>">最近</label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("order_popular"); ?>">热门</label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("order_comments"); ?>">最近评论</label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo $this->get_field_id("order_tags"); ?>">标签</label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('tabs_category'); ?>">显示分类</label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('tabs_date'); ?>">显示日期</label>
		</p>
