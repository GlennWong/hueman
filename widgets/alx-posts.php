...
/* ------------------------------------ */
	function AlxPosts() {
		parent::__construct( false, '文章', array('description' => 'Display posts from a category', 'classname' => 'widget_alx_posts') );;	
	}
	...
	<ul class="alx-posts group <?php if($instance['posts_thumb']) { echo 'thumbs-enabled'; } ?>">
		...
		<li>
			...
			<div class="post-item-inner group">
				...
				<?php if($instance['posts_date']) { ?><p class="post-item-date"><?php the_time('Y年m月j日'); ?></p><?php } ?>
			</div>
