...
<section id="comments" class="themeform">
	...
	<?php if ( have_comments() ) : global $wp_query; ?>
		...
		<h3 class="heading"><?php comments_number( __( '暂无评论', 'hueman' ), __( '1 个评论', 'hueman' ), __( '% 个评论', 'hueman' ) ); ?></h3>
	
		<ul class="comment-tabs group">
			<li class="active"><a href="#commentlist-container"><i class="fa fa-comments-o"></i><?php _e( '评论', 'hueman' ); ?><span><?php echo count($wp_query->comments_by_type['comment']); ?></span></a></li>
			<li><a href="#pinglist-container"><i class="fa fa-share"></i><?php _e( '引用', 'hueman' ); ?><span><?php echo count($wp_query->comments_by_type['pings']); ?></span></a></li>
		</ul>
